...
// The tabs block is the div that contains "isLogin ? 'چوونا ژوورێ'"
let tabsIdentifier = "isLogin ? 'چوونا ژوورێ'";
let tabsIdentifierPos = content.indexOf(tabsIdentifier);

// The start of the tabs block is the closest `<div className="flex bg-` before the tabsIdentifier
let tabsStart = content.lastIndexOf('<div className="flex bg-', tabsIdentifierPos);
