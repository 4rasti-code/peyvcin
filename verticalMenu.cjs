...
if (startIndex !== -1 && endIndex !== -1) {
    ...
    let newBlock = `<div className="w-full flex flex-col mt-2 space-y-3">
                                        <button
                                            ...
                                            title="Google"
                                        >
                                            <span className="font-bold font-rabar text-[12px] sm:text-xs">بەردەوامبوون ب ڕێکا گۆگڵ</span>
                                        ...
                                        >
                                            <span className="font-bold font-rabar text-[12px] sm:text-xs">بەردەوامبوون ب ڕێکا دیسکۆرد</span>
                                            <div className="absolute right-4 flex items-center justify-center">
                                        ...
                                        <button
                                            ...
                                            disabled={loading}
                                            className="relative w-full h-11 sm:h-10 bg-transparent border-2 border-emerald-500/50 hover:bg-emerald-500/10 text-emerald-500 rounded-md flex items-center justify-center active:scale-95 transition-all"
                                        >
                                            <span className="font-bold font-rabar text-[12px] sm:text-xs">یاریکردن وەکو مێهڤان</span>
                                            <div className="absolute right-4 flex items-center justify-center">
                                                <span className="material-symbols-outlined text-sm">person</span>
                                            </div>
                                        </button>

                                        <div className="mt-6 mb-2 flex flex-wrap items-center justify-center gap-3 sm:gap-4 text-[9.5px] font-black font-rabar text-mono-400 dark:text-white/30 uppercase">
    ...
    console.log("Menu vertically aligned successfully!");
}
