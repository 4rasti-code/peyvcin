            ...
            <>
              ...
              {user?.email === '4rasti@gmail.com' && (
                <button
                  ...
                  className="fixed bottom-32 right-4 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-full font-bold shadow-lg z-50 flex items-center gap-2 active:scale-95 transition-transform"
                >
