...
const AchievementsView = ({ profileData, onViewChange }) => {
  ...
  return (
    <div className="min-h-screen bg-mono-white dark:bg-black flex flex-col items-center safe-top safe-bottom overflow-x-hidden transition-colors duration-500" dir="rtl">
      {/* Header */}
      <div className="w-full max-w-lg flex items-center justify-between px-6 pt-[calc(env(safe-area-inset-top)+8px)] pb-2 sticky top-0 z-50 bg-mono-white dark:bg-black/95 border-b border-mono-100 dark:border-mono-800/30">
        <button 
        ...
        <h2 className="text-xl font-black font-rabar text-mono-900 dark:text-white uppercase">ئەرک</h2>
        <div className="w-10" />
      </div>
