                    ...
                    {!showOtpScreen ? (
                        ...
                        <div className="mt-4">
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="w-full h-11 sm:h-10 rounded-md bg-white text-mono-900 border border-mono-200 flex items-center justify-center gap-3 hover:bg-gray-50 active:scale-95 transition-all shadow-sm font-bold font-rabar text-sm sm:text-xs"
                                title="Google"
                            >
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="w-full mt-3 bg-[#5865F2] hover:bg-[#4752C4] text-white rounded-md h-11 sm:h-10 font-bold font-rabar text-sm sm:text-xs transition-all flex items-center justify-center gap-3 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed group relative overflow-hidden"
                            >
