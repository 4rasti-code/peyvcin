...
export default function SocialHubView({
  ...
  return (
    <div className="flex flex-col h-full bg-mono-white dark:bg-black text-mono-900 dark:text-mono-50 overflow-hidden transition-colors duration-500" dir="rtl">
      ...
      <div className="pb-2 w-full relative z-40" style={{ paddingTop: 'calc(env(safe-area-inset-top) + 0.5rem)', transform: 'translateY(var(--vv-offset-top, 0px))' }}>
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            {selectedChat ? (
              <div className="flex-1 flex flex-col overflow-hidden bg-mono-50 dark:bg-black">
                <div className="shrink-0 p-3 bg-mono-white dark:bg-mono-900 border-b border-mono-200 dark:border-mono-800 flex items-center justify-between relative z-40 shadow-sm transition-colors duration-300" style={{ transform: 'translateY(var(--vv-offset-top, 0px))' }}>
