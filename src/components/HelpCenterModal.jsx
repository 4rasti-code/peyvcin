...
const HELP_TOPICS = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'گسکێ سیحری چ دکەت؟', a: 'ب ٥٠٠ فلسان، گسکێ سیحری هندەک ژ وان پیتان ژ تەختەکلیکی دمالیت یێن کو د ناڤ پەیڤا ڤەشارتی دا نینن، دا کو یاری بۆ تە ب ساناتر بکەڤیت.' },
