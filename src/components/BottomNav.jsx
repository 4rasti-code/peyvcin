              ...
              >
                ...
                {tab.id === 'social_hub' && chatBadgeCount > 0 && (
                  <Motion.div
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                    className="absolute -top-2 -right-2 min-w-5 h-5 px-1 bg-red-500 text-white text-[10px] font-black font-sans rounded-full flex items-center justify-center border-[2.5px] border-mono-100 dark:border-mono-900 z-20 shadow-md"
                  >
                ...
                {tab.id === 'profile' && pendingFriendsCount === 0 && hasUnclaimedRewards && (
                  <Motion.div
                    ...
                    className="absolute -top-1.5 -right-1.5 w-3 h-3 bg-red-500 rounded-full border-2 border-mono-100 dark:border-mono-900 z-20 shadow-[0_0_8px_rgba(239,68,68,0.4)]"
                  />
                )}
                ...
                {tab.id === 'social_hub' && hasSilentGlobal && chatBadgeCount === 0 && (
                  <Motion.div
                    animate={{ scale: [1, 1.2, 1], opacity: [0.8, 1, 0.8] }}
                    transition={{ repeat: Infinity, duration: 2, ease: "easeInOut" }}
                    className="absolute -top-1.5 -right-1.5 w-3 h-3 bg-emerald-500 rounded-full border-2 border-mono-100 dark:border-mono-900 z-20 shadow-[0_0_8px_rgba(16,185,129,0.4)]"
                  />
                )}
