      ...
      {isVisible && (
        ...
        >
          ...
          >
            ...
            <div className="w-full bg-white/5 rounded-[2.5rem] border border-white/10 p-6 flex items-center justify-between relative">
            ...
            {/* REWARDS SECTION */}
            <div className="w-full space-y-3 bg-black/40 p-5 rounded-[2.5rem] border border-white/5 shadow-inner">
