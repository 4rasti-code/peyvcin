...
const DataDeletion = () => {
    ...
    const content = {
        ...
        ku: {
            ...
            lastUpdated: "دووماهیک نووژەنکرن: ٢ نیسان، ٢٠٢٦",
            intro: "ل پەیڤچن، ئەم ڕێزێ ل تایبەتمەندیا تە دگرین و ڕێگەکا ب ساناهی دابین دکەین بۆ داخوازکرنا ژێبرنا داتایێن تە یێن کەسی یێن کو ب پەیڤچن و فەیسبووکی ڤە گرێداینە.",
            ...
            steps: [
                "پرۆفایلێ خوە یێ فەیسبووکی ڤەکە و هەڕە 'Settings & Privacy' پاشان 'Settings'.",
            ...
            section2Title: "٢. کیژ داتای دێ هێنە ژێبرن؟",
            section2Text: "پشتی کو داخوازا ژێبرنێ دهێتە جێبەجێکرن، ئەڤ زانیاریێن خوارێ دێ ب ئێکجاری ژ سێرڤەرێن مە هێنە ڕەشکرن:",
            deletedItems: [
                "زانیاریێن پرۆفایلێ تە (ناڤ، وێنە)",
                "ئامارێن یاریێ (ئاست، XP، دینار، ستێرک)",
                "زانیاریێن رۆژانە و پەیڤێن تە یێن خەلاتکرین",
                "هەر گرێدانەکا جڤاکی یان ڕیزبەندییا سەرکەفتووان"
            ],
            section3Title: "٣. دەمێ جێبەجێکرنێ",
            section3Text: "داخوازێن ب ڕێکا ئیمەیلێ ب گشتی د ناڤبەرا ٣-٥ رۆژێن کار دا دهێنە جێبەجێکرن. پشتی ژێبرنێ، ئەڤ زانیارییە ناهێنە ڤەگەراندن.",
