...
const Keyboard = memo(({
   ...
   return (
      <div className={`flex flex-col gap-2 w-full px-1.5 pb-[max(0.75rem,env(safe-area-inset-bottom))] box-border select-none touch-manipulation relative z-10 transition-all duration-500 ${gameState !== 'playing' ? 'opacity-50 pointer-events-none grayscale' : ''}`} dir="rtl">
