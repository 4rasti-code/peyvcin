...
const PrivacyPolicy = () => {
    ...
    const content = {
        ...
        ku: {
            title: "ڕێبازا پاراستنا نهێنیێ",
            subtitle: "دووماهیک نویژەنکرن: ٢ نیسان، ۲۰۲٦",
            intro: "ئەم ل پەیڤچن هەمی هەولەکێ ددەین بۆ پاراستنا تایبەتمەندیا تە. ئەڤ ڕێبازە دیار دکەت کا ئەم چەوا پێزانینێن تە یێن کەسی بنکار دئینین دەما تو یارییا مە بەکار دهینی.",
            sections: [
                {
                    title: "١. ئەو پێزانینێن ئەم کۆم دکەین",
                    text: "دەما تو پەیڤچن بەکار دهینی، دبیت ئەڤ پێزانینە بهێنە کۆمکرن:",
                    list: [
                        "پێزانینێن گشتی یێن پڕۆفایلی (ناڤ، وێنە) ژ فەیسبووکی یان گووگڵی.",
                        "ئیمەیڵا هاتیە پێشکێشکرن دەما چوونەژوورێ.",
                ...
                {
                    title: "٢. چەوا ئەم داتایێن فەیسبووکی بەکار دهینین",
                    text: "هەکە تە هەلبژارت ب ڕێیا فەیسبووکی بچی د ژۆردا، ئەم ب تنێ دەستەکا مە ل سەر وان پێزانینان هەیە کو تە ڕێپێدان پێ دایە. ئەم ڤان داتایان بەکار دهینین بۆ:",
                    list: [
                        "دروستکرنا پڕۆفایلێ تە یێ تایبەت د ناڤ یاریێدا.",
                        "پیشاندانا ناڤ و وەلاتی تە د لیستا جیهانی یا سەرکەفتوواندا.",
                        "هەڤدەمکرنا (Sync) پێشکەفتنا تە د یاریێدا د ناڤبەرا چەندین ئامیران دا."
                    ]
                },
                {
                    title: "٣. پاراستنا داتایان",
                    text: "داتایێن تە ب شێوەیەکێ گەلەک تەناهی دهێنە پاراستن ب ڕێیا Supabase. ئەم چو پێزانینێن تە یێن تایبەت نادەینە چو لایەنەکێ دی بۆ مەبەستێن ڕیکلامێ."
                },
                {
                    title: "٤. مافێن تە و ژێبرنا داتایان",
                    text: "مافێ تە هەیە ل هەر دەمەکی پێزانینێن خۆ ببینی، دەستکاری بکەی، یان ژی ببەی. تایبەت بۆ بەکارهێنەرێن فەیسبووکی:",
                    list: [
                        "بۆ ژێبرنا چالاکیێن یاریێ، هەرە د ناڤ پڕۆفایلێ خۆ یێ فەیسبووکی > Settings & Privacy > Settings > Apps and Websites.",
                        "پەیڤچن (پەیڤچن App) بببینە و کلیک بکە ل سەر Remove.",
                        "یان ژی تو دشێی ئیمەیڵەکێ بۆ مە بنێری ل سەر support@peyvchin.com بۆ داخوازکرنا ژێبرنا ئێکجارە یا ئەکاونتی و هەمی داتایێن یاریێ."
                    ]
                },
                {
                    title: "٥. پەیوەندی ب مە ڤە بکە",
                    text: "ئەگەر تە هەر پسیارەک یان تێبینیەک هەبیت ل سەر ڤێ ڕێبازێ، هیڤییە پەیوەندیێ ب مە ڤە بکەی ب ڕێیا:",
                    email: "support@peyvchin.com"
                }
            ]
        }
            ...
            <div className="max-w-4xl mx-auto relative">
                ...
                <div className="mt-16 text-center space-y-8">
                    <div className="flex flex-wrap items-center justify-center gap-6 text-white/30 font-bold text-xs uppercase tracking-widest">
                        ...
                        <button onClick={() => navigate('/privacy-policy')} className="text-primary hover:text-white transition-colors">Privacy Policy</button>
                        <span className="w-1 h-1 rounded-full bg-white/10"></span>
