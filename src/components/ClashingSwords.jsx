...
const Sword = ({ className }) => (
  <svg viewBox="0 0 100 100" className={className} xmlns="http://www.w3.org/2000/svg">
    ...
    {/* Handle Left Face */}
    <rect x="41" y="75" width="9" height="16" fill="#9a3412" />
    {/* Handle Right Face */}
    <rect x="50" y="75" width="9" height="16" fill="#7c2d12" />
  ...
  return (
    <div
      ...
      style={{
        ...
        height: '2px',
        top: '50%', left: '50%',
        marginLeft: '-5px', marginTop: '-1px', // Centers perfectly
        '--tx': `${x}px`,
        '--ty': `${y}px`,
        '--rot': `${rot}deg`,
        boxShadow: '0 0 6px 2px #ea580c, 0 0 2px 1px #fef08a',
  ...
  return (
    <div className={`relative flex items-center justify-center ${className}`}>
      <style>
        {`
          @keyframes sword-left-anim {
            0%, 86% { transform: rotate(35deg) translateZ(0); }
            90% { transform: rotate(-15deg) translateZ(0); }
            95% { transform: rotate(45deg) translateZ(0); }
            100% { transform: rotate(35deg) translateZ(0); }
          }
          ...
          @keyframes sword-spark {
            ...
            94% { 
              transform: translate(calc(var(--tx) * 0.3), calc(var(--ty) * 0.3)) rotate(var(--rot)) scaleX(3) scaleY(0.8) translateZ(0); 
              opacity: 1; 
            }
            100% { 
              transform: translate(var(--tx), var(--ty)) rotate(var(--rot)) scaleX(0.5) scaleY(0.1) translateZ(0); 
              opacity: 0; 
            }
          }
        `}
      ...
      <div className="absolute inset-0" style={{ transform: 'translateY(-15%) translateZ(0)', backfaceVisibility: 'hidden' }}>
        ...
        >
          <Sword className="w-full h-full drop-shadow-xl overflow-visible" />
        </div>
