    ...
    <div className="space-y-3 mt-6 bg-[#f8fafc] p-4 rounded-xl border border-[#cbd5e1] shadow-sm">
      ...
      <ul className="space-y-3 mt-2">
        <li className="flex gap-2.5 text-[11px] font-bold text-[#4a5568] leading-relaxed items-start">
          ...
          <span>
            <strong className="text-[#181a20]">درێژیا پەیڤێ (ژ ڕاست بۆ چەپ):</strong> ھەژمارا خانەیان د یەک ڕێزێ دا نیشانا درێژیا پەیڤێ یە. بۆ نموونە، ھەگەر یاریێ {toKuDigits(5)} خانە داینە تە، پێدڤییە پەیڤەکا {toKuDigits(5)} پیتی بنڤیسی.
          </span>
        </li>
        <li className="flex gap-2.5 text-[11px] font-bold text-[#4a5568] leading-relaxed items-start">
          <span className="text-[#1e86ff] mt-0.5 shrink-0 material-symbols-outlined text-[14px]">height</span>
          <span>
            <strong className="text-[#181a20]">ژمارەیا بزاڤان (ژ سەر بۆ بن):</strong> ھەژمارا ڕێزان نیشانا ژمارەیا ھەوڵان یان بزاڤانە کو یاریێ داینە تە بۆ دیتنا پەیڤێ.
          </span>
        </li>
        <li className="flex gap-2.5 text-[11px] font-bold text-[#4a5568] leading-relaxed items-start">
          <span className="text-[#1e86ff] mt-0.5 shrink-0 material-symbols-outlined text-[14px]">menu_book</span>
          <span>
            <strong className="text-[#181a20]">فەرھەنگا یاریێ:</strong> ھەر پەیڤەکا تو دنڤیسی پێدڤییە د ناڤ فەرھەنگا یاریێ دا ھەبیت. ھەگەر ئەو پەیڤ د فەرھەنگێ دا نەبیت، یاری قەبیل ناکەت.
          </span>
        </li>
      </ul>
    </div>
    ...
    <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="space-y-3">
        ...
        <ul className="space-y-2">
          ...
          <li className="flex gap-2 text-[12px] font-bold text-[#4a5568] leading-relaxed">
            <span className="text-[#a0a7b4]">•</span>
            <span>مۆدێ پەیڤۆک (کلاسیک) ژ وان پەیڤان پێکدھێن ئەوێن کو ژ {toKuDigits(2)} تا {toKuDigits(5)} پیتان پێکدھێن.</span>
          </li>
        </ul>
        <p className="text-[12px] font-bold text-[#4a5568] leading-relaxed">
          پشتی ھەر بزاڤەکێ، ڕەنگێن خانەیان دێ ھێنە گوھۆڕین، داکو نیشان بدەت کا پەیڤا تە چەند نیزیکە ژ پەیڤا ڕاست.
        </p>
      </div>
      ...
      {renderExplanations(
        <>پیتا <span className="text-[#22c55e] font-black">پ</span> د ناڤ پەیڤێدا ھەیە و د خانەیا ڕاست دایە.</>,
        <>پیتا <span className="text-[#f59e0b] font-black">ێ</span> و <span className="text-[#f59e0b] font-black">م</span> د ناڤ پەیڤێدا ھەیە، لێ بەلێ یا د خانەیەکا شاشدا.</>,
      ...
      <p className="text-[12px] font-bold text-[#4a5568] leading-relaxed mt-2">
        پێدڤییە یاریزان وان ئاماژەیان بکاربینن بۆ ڕاستڤەکرن و باشترکرنا بزاڤێن خوە تا کو پەیڤا ڤەشارتی ئاشکرا دکەن. ئارمانجا سەرەکی ئەوە کو د ناڤ شەش بزاڤان دا پەیڤ بھێتە دیتن.
      </p>
    </div>
  );
  ...
  const renderMultiplayerTutorial = () => (
    <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="space-y-3">
        <p className="text-[13px] font-black font-rabar text-[#181a20]">ئارمانجا یاریێ:</p>
        <p className="text-[12px] font-bold text-[#4a5568] leading-relaxed">
          ئارمانجا یاریێ ئەوە تو پەیڤا ڤەشارتی د {toKuDigits(3)} بزاڤان دا ببینی. مۆدێ (ھەڤڕکی)، ژ وان پەیڤان پێکدھێن ئەڤێن کو ژ {toKuDigits(5)} پیتان پێکدھێن. ھەر بزاڤەک دێ پەیڤەکا {toKuDigits(5)} پیتی بیت.
        </p>
      </div>
      ...
      {renderExplanations(
        <>پیتا <span className="text-[#22c55e] font-black">(پ)</span> د ناڤ پەیڤێ دا ھەیە و د جھێ خوە یێ ڕاست دایە.</>,
        <>پیتا <span className="text-[#f59e0b] font-black">(ێ)</span> و <span className="text-[#f59e0b] font-black">(م)</span> د ناڤ پەیڤێ دا ھەیە، بەلێ یا د جھێ شاشە دایە.</>,
      ...
      <div className="space-y-3 mt-4">
        ...
        <p className="text-[12px] font-bold text-[#4a5568] leading-relaxed">
          ھەر یاریزانەکێ {toKuDigits(2)} خالێن وی ژ خالێن یاریزانێ ھەڤڕک زێدەتر بن، ئەو دێ ب سەرکەڤیت. ئەگەر خالێن ھەردوو یاریزانان بوونە {toKuDigits(3)} ب {toKuDigits(3)}، ل وی دەمی یاری دێ ب یاکسانبوون ھێتە ھژمارتن و دێ یاری ب دوماھیک ھێت.
        </p>
      </div>

      <div className="space-y-3">
        <h4 className="text-[13px] font-black font-rabar text-[#181a20]">ھەڤڕکییا زیندی:</h4>
        <p className="text-[12px] font-bold text-[#4a5568] leading-relaxed">
          دەمێ کو یاریزانێ {toKuDigits(1)} پەیڤێ د خانەیان دا دنڤیسیت، ڕاستەوخۆ ل دەف یاریزانێ ھەڤڕک دیار دبیت کا یاریزانێ {toKuDigits(1)} گەھشتییە چ قۆناغا نڤێسینێ، لێ پەیڤ دیار نابیت کا یاریزانێ {toKuDigits(1)} چ پیتێ د خانەیێ دا دنڤیسیت. ب تنێ ڕەنگێن پیتا ڕاست ل جھێ ڕاست، پیتا ڕاست ل جھێ شاش، و پیتا کو د پەیڤێ دا نینە، ڕاستەوخۆ ل دەف یاریزانێ ھەڤڕک دیار دبیت.
        </p>
      </div>

      <p className="text-[12px] font-bold text-[#4a5568] leading-relaxed">
        پێدڤییە یاریزان وان ئاماژەیان بکاربھینن بۆ ڕاستڤەکرن و باشترکرنا بزاڤێن خوە تا کو پەیڤا ڤەشارتی ئاشکرا دکەن. ئارمانجا سەرەکی ئەوە کو د ناڤ {toKuDigits(3)} بزاڤان دا پەیڤ بھێتە دیتن.
      </p>
    </div>
  );
    ...
    <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="space-y-3">
        ...
        <ul className="space-y-2">
          <li className="flex gap-2 text-[12px] font-bold text-[#4a5568] leading-relaxed">
            <span className="text-[#a0a7b4]">•</span>
            <span>د مۆدێ (مامک) دا، پرسیارەک یان مامکەک دێ ژ تە ھێتە کرن و پێدڤییە تو بەرسڤێ (پەیڤا ڤەشارتی) د {toKuDigits(6)} بزاڤان دا ببینی.</span>
          </li>
          <li className="flex gap-2 text-[12px] font-bold text-[#4a5568] leading-relaxed">
            <span className="text-[#a0a7b4]">•</span>
            <span>درێژییا بەرسڤێ (مامکێ) ل دویڤ ھژمارا خانەیان دێ دیار بیت و ڕەنگە ژ {toKuDigits(2)} تا چەندین پیتان پێکبھێت.</span>
          </li>
        </ul>
      </div>
      ...
      <div className="bg-[#f8fafc] border border-slate-200 p-4 rounded-xl shadow-sm text-center mt-6">
        ...
        <p className="text-[12px] font-bold text-slate-700 leading-relaxed">
          "چوومە بەحرەکا شین، دوو سوار پێدا خشین، ئێک ھەسپە، ئێک ماھین."
        </p>
      </div>

      <div className="space-y-3 mt-4">
        <p className="text-[12px] font-bold text-[#4a5568] leading-relaxed">
          ل دویڤ مامکێ تو تێدگەھی کو بەرسڤ (ئەسمان)ـە. تو دشێی بزاڤێن خوە بنڤیسی تا دگەھییە پەیڤا ڕاست:
        </p>
      </div>
      ...
      {renderExplanations(
        <>پیتا <span className="text-[#22c55e] font-black">ە</span> و <span className="text-[#22c55e] font-black">ا</span> و <span className="text-[#22c55e] font-black">ن</span> د ناڤ پەیڤێ دا ھەنە و د جھێ خوە یێ ڕاست دانە.</>,
        <>پیتا <span className="text-[#f59e0b] font-black">م</span> د ناڤ پەیڤێ دا ھەیە، لێ یا د جھێ شاش دا.</>,
    ...
    <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="space-y-3">
        ...
        <ul className="space-y-2">
          ...
          <li className="flex gap-2 text-[12px] font-bold text-[#4a5568] leading-relaxed">
            <span className="text-[#a0a7b4]">•</span>
            <span>مۆد (تایا پەیڤان) ژ وان پەیڤان پێکدھێت ئەڤێن کو ژ {toKuDigits(5)} پیتان پێکدھێن، ھەروەسا یاریەکا بلەزە و پێدڤییە ژبەری کو {toKuDigits(30)} چرکە ب دوماھیک بھێن تو پەیڤێ ببینی.</span>
          </li>
        </ul>
      </div>
      ...
      <div className="space-y-3">
        <p className="text-[12px] font-bold text-[#4a5568] leading-relaxed">
          پشتی ھەر بزاڤەکێ، ڕەنگێن خانەیان دێ ھێنە گوھۆڕین، دا کو نیشان بدەت کا پەیڤا تە چەند نێزیکە ژ پەیڤا ڕاست.
        </p>
      </div>
      ...
      <p className="text-[12px] font-bold text-[#4a5568] leading-relaxed mt-2">
        پێدڤییە یاریزان وان ئاماژەیان بکاربینن بۆ ڕاستڤەکرن و باشترکرنا بزاڤێن خوە تا کو پەیڤا ڤەشارتی ئاشکرا دکەن. ئارمانجا سەرەکی ئەوە کو د ناڤ سێ بزاڤان دا پەیڤ بھێتە دیتن.
      </p>
    </div>
  );
    ...
    <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="space-y-3">
        ...
        <ul className="space-y-2">
          ...
          <li className="flex gap-2 text-[12px] font-bold text-[#4a5568] leading-relaxed">
            <span className="text-[#a0a7b4]">•</span>
            <span>مۆدێ (پەیڤێن دژوار) ژ وان پەیڤان پێکدھێن ئەڤێن کو ژ {toKuDigits(6)} تا ∞ پیتان پێکدھێن.</span>
          </li>
        </ul>
      </div>
      ...
      {renderExplanations(
        <>پیتا <span className="text-[#22c55e] font-black">پ</span> د ناڤ پەیڤێدا ھەیە و د خانەیا ڕاست دایە.</>,
        <>پیتا <span className="text-[#f59e0b] font-black">گ</span> و <span className="text-[#f59e0b] font-black">ر</span> د ناڤ پەیڤێدا ھەیە، لێ بەلێ یا د خانەیەکا شاشدا.</>,
  ...
  const renderGenericTemplate = (modeId) => {
    ...
    return (
      <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <p className="text-[12px] font-bold text-[#4a5568] leading-relaxed">
          یاسایێن ڤی مۆدێ یاریێ ل ڤێرە دێ ھێنە نڤێسین. ڤی مۆدێ تایبەت یاریێ یێ جودایە و پێدڤی ب زیرەکیەکا جودا ھەیە.
        </p>
          ...
          <ul className="space-y-2">
            {[1, 2, 3].map(i => (
              <li key={i} className="flex gap-2.5">
                ...
                <p className="text-[12px] font-bold text-[#4a5568]">خالا فێربوونێ یا {toKuDigits(i)} ل ڤێرە دێ ھێتە دیارکرن بۆ یاریزانی.</p>
              </li>
            ))}
          </ul>
        </div>
