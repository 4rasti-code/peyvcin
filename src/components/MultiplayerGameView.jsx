    ...
    >
      ...
      <div className="battlefield-container no-scrollbar pt-[calc(env(safe-area-inset-top)+clamp(44px,8vw+12px,56px))]" dir="rtl">
        ...
        <div className={`flex-1 min-h-0 flex flex-col items-center justify-center p-1 pb-6 sm:pb-1 ${isDark ? 'bg-white/5' : 'bg-white/60'}`}>
          <div 
            className={`flex items-center justify-between gap-3 mb-3 h-[60px] relative ${isDark ? 'bg-mono-900/70 border-mono-700/80 shadow-[0_8px_30px_rgba(0,0,0,0.6)] ring-1 ring-white/5' : 'bg-white/85 border-slate-300 shadow-lg'} border rounded-lg px-4 backdrop-blur-lg transition-all duration-300 ease-out`}
        ...
        <div className={`flex-1 min-h-0 flex flex-col items-center justify-center p-1 pt-6 sm:pt-1 ${isDark ? 'bg-black/40' : 'bg-black/5'}`}>
          ...
          <div 
            className={`flex items-center justify-between gap-3 mt-3 h-[60px] relative ${isDark ? 'bg-mono-900/70 border-mono-700/80 shadow-[0_8px_30px_rgba(0,0,0,0.6)] ring-1 ring-white/5' : 'bg-white/85 border-slate-300 shadow-lg'} border rounded-lg px-4 backdrop-blur-lg transition-all duration-300 ease-out`}
            style={{ width: gridWidth, minWidth: '230px' }}
          >
