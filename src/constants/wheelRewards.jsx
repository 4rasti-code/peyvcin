...
export const WHEEL_REWARDS = [
  ...
  { id: 2, type: 'skip', amount: 1, label: '١', winnable: true, weight: 20, color: '#F97316', Icon: SkipIcon, size: 9 },
  ...
  { id: 5, type: 'magnet', amount: 1, label: '١', winnable: true, weight: 90, color: '#84CC16', Icon: MagnetIcon, size: 9 },
  ...
  { id: 10, type: 'hint', amount: 1, label: '١', winnable: true, weight: 100, color: '#3B82F6', Icon: HintIcon, size: 9 },
  { id: 11, type: 'magnet', amount: 2, label: '٢', winnable: true, weight: 50, color: '#F59E0B', Icon: MagnetIcon, size: 9 },
