...
export const MEDALS = [
  ...
  { id: 'shanazi_kurdistan', name: 'شانازیا کوردستانێ', condition: (d) => (d.kurdish_words_completed || 0) >= 1000, color: 'text-emerald-500', glow: '', IconComponent: KurdishShieldIcon, tooltip: '١٠٠٠ پەیڤێن کوردی دیتین', rewardAmount: 3000 },
  { id: 'shanazi_jihani', name: 'شاهێ پەیڤان', condition: (d) => (d.words_without_hints || 0) >= 1000, color: 'text-purple-400', glow: '', IconComponent: KingOfTheLettersIcon, tooltip: '١٠٠٠ پەیڤان بێی هاریکاری بینە', rewardAmount: 10000 },
];
