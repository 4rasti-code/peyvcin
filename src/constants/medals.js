...
export const MEDALS = [
  ...
  { id: 'shanazi_jihani', name: 'شاهێ پەیڤان', condition: (d) => (d.flawless_wins || 0) >= 1000, color: 'text-purple-400', glow: '', IconComponent: KingOfTheLettersIcon, tooltip: '١٠٠٠ پەیڤان بێی هاریکاری بینە', unlockedText: 'تاجێ زێڕین یێ پەیڤان ل سەر سەرێ تە یە، چرایەک ژ تە گەشتر نینە ل مەیدانێ.', rewardAmount: 10000 },
];
