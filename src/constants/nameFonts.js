export const NAME_FONTS = {
  ...
  'brlnsb': {
    id: 'brlnsb',
    name: 'Berlin Sans',
    style: { fontFamily: '"BRLNSB", sans-serif', fontSize: '1.20em' },
    language: 'english',
    price: 1000,
    currency: 'fils'
  },
  ...
  'design-lover': {
    id: 'design-lover',
    name: 'Design Lover',
    style: { fontFamily: '"Design Lover", sans-serif', fontSize: '1.20em' },
    language: 'english',
    price: 3500,
    currency: 'fils'
  },
  'futura-outline': {
    id: 'futura-outline',
    name: 'Futura Outline',
    style: { fontFamily: '"Futura Outline", sans-serif', fontSize: '1.20em' },
    language: 'english',
    price: 5000,
    currency: 'fils'
  },
  'lcd': {
    id: 'lcd',
    name: 'LCD',
    style: { fontFamily: '"LCD", sans-serif', fontSize: '1.20em' },
    language: 'english',
    price: 7500,
    currency: 'fils'
  },
  ...
  'runiga': {
    id: 'runiga',
    name: 'Runiga',
    style: { fontFamily: '"Runiga", sans-serif', fontSize: '1.20em' },
    language: 'english',
    price: 10000,
    currency: 'fils'
  },
  'fungky-brow': {
    id: 'fungky-brow',
    name: 'Fungky Brow',
    style: { fontFamily: '"Fungky Brow", sans-serif', fontSize: '1.20em' },
    language: 'english',
    price: 12000,
    currency: 'fils'
  },
  ...
  'blunt-wide': {
    id: 'blunt-wide',
    name: 'Blunt Wide',
    style: { fontFamily: '"Blunt Wide", sans-serif', fontSize: '1.20em' },
    language: 'english',
    price: 25000,
    currency: 'fils'
  },
  ...
  'filxgirl': {
    id: 'filxgirl',
    name: 'Filxgirl',
    style: { fontFamily: '"Filxgirl", sans-serif', fontSize: '1.20em' },
    language: 'english',
    price: 50000,
    currency: 'fils'
  },
  ...
  'my-butterfly': {
    id: 'my-butterfly',
    name: 'My Butterfly',
    style: { fontFamily: '"My Butterfly", sans-serif', fontSize: '1.20em' },
    language: 'english',
    price: 10,
    currency: 'derhem'
  },
  'sahir-yesta': {
    id: 'sahir-yesta',
    name: 'Sahir Yesta',
    style: { fontFamily: '"Sahir Yesta", sans-serif', fontSize: '1.20em' },
    language: 'english',
    price: 20,
    currency: 'derhem'
  },
  ...
  'daffiys': {
    id: 'daffiys',
    name: 'Daffiys',
    style: { fontFamily: '"Daffiys", sans-serif', fontSize: '1.20em' },
    language: 'english',
    price: 35,
    currency: 'derhem'
  },
  ...
  'awesome-christmas': {
    id: 'awesome-christmas',
    name: 'Awesome Christmas',
    style: { fontFamily: '"Awesome Christmas", sans-serif', fontSize: '1.20em' },
    language: 'english',
    price: 150,
    currency: 'derhem'
  },
  'mgf-pinlock': {
    id: 'mgf-pinlock',
    name: 'MGF Pinlock',
    style: { fontFamily: '"MGF Pinlock", sans-serif', fontSize: '1.20em' },
    language: 'english',
    price: 250,
    currency: 'derhem'
  },
  ...
  // DINAR
  'ncl-halloween-danger': {
    id: 'ncl-halloween-danger',
