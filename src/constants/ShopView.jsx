                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            {Object.values(BUNDLES).filter(b => b.id !== 'default').map(bundle => (
                                ...
                                >
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-between items-center bg-black/80 p-3 px-4 w-full relative z-10 gap-3 border-t border-white/10 overflow-visible">
